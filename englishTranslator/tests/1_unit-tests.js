...
suite('Unit Tests', () => {
  ...
  test.skip("#We had a party at my friend's condo.", async function () {
  ...
  test.skip("#The parking lot was full.", async function () {
    let input = `The parking lot was full.`
    let output = `The <span class="highlight"> car park</span> was full.`
    assert.equal(output, await translator.translate(amToBrit, input));
  })

  test.skip("#Like a high tech Rube Goldberg machine.", async function () {
  ...
  test.skip("#To play hooky means to skip class or work.", async function () {
  ...
  test.skip("#Lunch is at 12:15 today.", async function () {
